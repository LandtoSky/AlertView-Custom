...
- (UIView*) customView
{
    SaveGroupAlertView *customAlertView = [[[NSBundle mainBundle] loadNibNamed:@"SaveGroupAlertView" owner:self options:nil] objectAtIndex:0];
    [customAlertView.cancelBtn addTarget:self action:@selector(onCancelBtn:) forControlEvents:UIControlEventTouchUpInside];
    [customAlertView.saveBtn addTarget:self action:@selector(onSaveBtn:) forControlEvents:UIControlEventTouchUpInside];
